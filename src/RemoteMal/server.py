...
class RemoteServer(object):
    ...
    def UnixBackDir(self,cmd):
        ...
        self.current_path=self.path
        # self.send(self.path)
        self.path=UnixPathLib.BackDir(self.user,UnixPathLib.ReverseReplacer(self.path,self.user),cmd[3:len(cmd)])
...
if __name__=="__main__":
    ...
    # print(r.user)
    # print(r.device)
    r.path,r.user="/home/nalan","nalan"
    r.UnixBackDir("cd ../home")
    print(r.path)
