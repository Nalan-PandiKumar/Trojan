...
__all__=['isabsolute','isrelative','remover','splitdirectory','isdirectories','isdirectory','CountDirectories','DriveAPath','BackDir','replacer','RemoveDot','BackDotRemover']
